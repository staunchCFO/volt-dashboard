          ...
          <Row>
            <Col xs={12} className="text-center">
              ...
              <div className="d-flex align-items-center justify-content-center">
                <Button variant="secondary" as={Link} to={Routex.DashboardOverview.path} className="text-dark me-3">
        ...
        <Container>
          <Row className="justify-content-between align-items-center mb-5 mb-lg-7">
            <Col lg={5} className="order-lg-2 mb-5 mb-lg-0">
              ...
              <Button as={Link} to={Routex.DashboardOverview.path} variant="secondary" target="_blank">Live Demo <FontAwesomeIcon icon={faExternalLinkAlt} className="ms-1" /></Button>
          ...
          <Row className="justify-content-between align-items-center mb-5 mb-lg-7">
            <Col lg={5}>
              ...
              <Button as={Link} to={Routex.Forms.path} variant="secondary" className="mb-5 mb-lg-0" target="_blank"><FontAwesomeIcon icon={faReact} className="me-1" /> Components examples</Button>
            </Col>
          ...
          <Row className="d-flex align-items-center">
            <Col xs={12} lg={6} className="mb-4">
              <div className="d-none d-lg-block mt-5">
                ...
                <Button as={Link} variant="secondary" size="md" to={Routex.DocsFolderStructure.path} target="_blank" className="text-dark">
            ...
            <Col xs={12} lg={6} className="order-lg-first d-flex justify-content-center">
              <ListGroup className="d-block fmw-100 list-style-none folder-structure">
                ...
                <ListGroup className="list-style-none ps-4">
                  ...
                  <FolderItem name="Routex.js" tooltip="The file where the Routex are registered at" icon={faJs} iconColor="secondary" />
                </ListGroup>
          ...
          <Row className="justify-content-center">
            <Col md={10} xl={9}>
              ...
              <p className="mt-4 text-white text-center mb-0">
                Looks unfamiliar? Don’t worry! Our <Link to={Routex.DocsQuickStart.path} className="text-white text-underline fw-bold" target="_blank">documentation</Link> has got you covered.
              </p>
            </Col>
          </Row>
        </Container>
        ...
        <Container>
          <Row>
            ...
            <Col xs={6} md={2} className="mb-5 mb-lg-0">
              ...
              <ul className="links-vertical mt-2">
                <li>
                  <Card.Link as={Link} to={Routex.DocsQuickStart.path} target="_blank">Getting started</Card.Link>
                </li>
                <li><Card.Link as={Link} to={Routex.DocsChangelog.path} target="_blank">Changelog</Card.Link></li>
